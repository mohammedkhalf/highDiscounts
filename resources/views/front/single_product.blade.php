                    ...
                    <div class="single-sidebar">
                       ...
                       <a href="{{url('/single_product/'.$similar->id)}}">
                        <div class="thubmnail-recent">
                            <img style="height: 100px; width: auto" src="{{url('/upload/products/'.$similar->photo)}}"  alt="{{$similar->en_title}}" />
                            <h2><a href="">@if(lang() == 'ar') {{$similar->ar_title}} @else {{$similar->en_title}} @endif</a></h2>
                        ...
                        <div class="related-products-wrapper">
                            ...
                            <div class="related-products-carousel">
                                ...
                                <div class="single-product">
                                    ...
                                    <h2><a href="">@if(lang() == 'ar'){{$rated->ar_title}} @else {{$rated->en_title}} @endif</a></h2>
