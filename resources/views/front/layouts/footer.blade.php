                            ...
                            <div class="body">
                                ...
                                <div class="menu-footer-menu-2-container">
                                    <ul id="menu-footer-menu-2" class="menu">
                                        <li class="menu-item"><a href="{{url('/vendorregister')}}">Register as vendor</a></li>
...
{{Html::script('front/assets/js/jquery.min.js')}}
{{Html::script('front/assets/js/tether.min.js')}}
