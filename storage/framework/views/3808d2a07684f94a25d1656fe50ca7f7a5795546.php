...
<!-- jQuery sticky menu -->
<?php echo e(Html::script('front/js/owl.carousel.min.js')); ?>

<?php echo e(Html::script('front/js/jquery.sticky.js')); ?>


<!-- jQuery easing -->
<?php echo e(Html::script('front/js/jquery.easing.1.3.min.js')); ?>


<!-- Main Script -->
<?php echo e(Html::script('front/js/main.js')); ?>


<!-- Slider -->
<?php echo e(Html::script('front/js/bxslider.min.js')); ?>

<?php echo e(Html::script('front/js/script.slider.js')); ?>
