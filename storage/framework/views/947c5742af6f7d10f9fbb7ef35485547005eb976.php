                            ...
                            <div class="body">
                                ...
                                <div class="menu-footer-menu-2-container">
                                    <ul id="menu-footer-menu-2" class="menu">
                                        <li class="menu-item"><a href="<?php echo e(url('/registervendor')); ?>">Register as vendor</a></li>
...
<?php echo e(Html::script('front/assets/js/jquery.min.js')); ?>

<?php echo e(Html::script('front/assets/js/tether.min.js')); ?>

<?php echo e(Html::script('front/assets/js/bootstrap.min.js')); ?>

<?php echo e(Html::script('front/assets/js/bootstrap-hover-dropdown.min.js')); ?>

<?php echo e(Html::script('front/assets/js/owl.carousel.min.js')); ?>

<?php echo e(Html::script('front/assets/js/echo.min.js')); ?>

<?php echo e(Html::script('front/assets/js/wow.min.js')); ?>

<?php echo e(Html::script('front/assets/js/jquery.easing.min.js')); ?>

<?php echo e(Html::script('front/assets/js/jquery.waypoints.min.js')); ?>

<?php echo e(Html::script('front/assets/js/electro.js')); ?>
