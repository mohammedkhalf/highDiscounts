                    ...
                    <ul class="navbar-mini-cart navbar-nav animate-dropdown nav pull-right flip">
                        ...
                        <li class="nav-item dropdown">
                            <a href="<?php echo e(url('/shopping-cart')); ?>" class="nav-link" data-toggle="dropdown">
                                ...
                                <span class="cart-items-total-price total-price"><span class="amount"><?php echo e($total); ?> LE</span></span>
                                  <?php endif; ?>
                            </a>
                                    ...
                                    <div class="widget_shopping_cart_content">
                                        ...
                                        <ul class="cart_list product_list_widget ">
                                            ...
                                            <li class="mini_cart_item">
                                                 <?php echo Form::open(['method'=>'delete','url'=>'/destroy_item/'.$products->id]); ?> 
                                                <button title="Remove this item" type="submit" class="remove" href="<?php echo e(url('/destroy_item/'.$products->id)); ?>">×</button>
                                                 <?php echo Form::close(); ?>

                                                <a href="single_product/<?php echo e($products->shoppings()->first()->id); ?>">
                                                    <img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" src="<?php echo e(url('/upload/products/'.$products->shoppings()->first()->photo)); ?>" alt=""><?php echo e($products->shoppings()->first()->en_title); ?>
 ...
 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <p class="total"><strong>Total:</strong> <span class="amount"><?php echo e($total); ?> LE</span></p>
