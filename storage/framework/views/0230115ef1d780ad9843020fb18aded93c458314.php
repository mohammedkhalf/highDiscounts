    ...
    <div class="panel panel-flat">
        ...
        <table class="table datatable-button-html5-columns">
            ...
            <tr>
                ...
                <th><?php echo e(trans('admin.city_mob')); ?></th>
                <th>Edit</th>
                <th>Delete</th>
            </tr>
            </thead>
            ...
            <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><?php echo e($city->country_name_ar); ?></td>
                    <td><?php echo e($city->country_name_en); ?></td>
                    <td><?php echo e($city->mob); ?></td>
                    <td><a href="<?php echo e(aurl('countries/edit/'.$city->id)); ?>"><i class="icon-pen6"></i> <span>edit</span></a>
                    </td>
