            ...
            <div class="panel panel-body login-form">
                ...
                <div class="form-group has-feedback has-feedback-left">
                    ...
                    <select class="form-control" name="main_lang">
                        <option value="ar"  <?php if(sett()->main_lang == 'ar'): ?> selected <?php endif; ?>>عربى</option>
                        <option value="en"   <?php if(sett()->main_lang == 'en'): ?> selected <?php endif; ?>>English</option>
                    </select>
                    <div class="form-control-feedback">
                        <i class="icon-indent-decrease text-muted"></i>
                    </div>
                ...
                <div class="form-group has-feedback has-feedback-left">
                    ...
                    <select name="status" class="form-control">
                        ...
                        <option value="open" <?php if(sett()->status == 'open'): ?> selected <?php endif; ?>>open</option>
                        <option value="close"  <?php if(sett()->status == 'close'): ?> selected <?php endif; ?>>close</option>
                ...
                <div class="form-group has-feedback has-feedback-left">
                    ...
                    <input type="text" name="message_mentenance" value="<?php echo sett()->message_mentenance; ?>"
                           class="form-control">
                    <div class="form-control-feedback">
